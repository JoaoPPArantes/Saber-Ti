...
type
  ...
  TFPesqProduto = class(TForm)
    ...
    procedure edtQntdExit(Sender: TObject);
...
procedure TFPesqProduto.edtQntdExit(Sender: TObject);
begin
     edtValorFinal.Text:= FloatToStr(StrToInt(edtQntd.Text) * StrToFloat(dbValor.Text));
end;
